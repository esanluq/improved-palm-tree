...
activities = {
    ...
    "Music Ensemble": {
        "description": "Group rehearsals for band and ensemble performances",
    ...
    "Debate Team": {
        "description": "Learn debate techniques and compete in regional tournaments",
        "schedule": "Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
        "participants": ["lucas@mergington.edu", "sophia.b@mergington.edu"]
    },
    "Science Club": {
